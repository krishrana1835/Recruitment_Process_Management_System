          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem className="cursor-pointer">
              <Link
                ...
                className="flex flex-row"
              >
                <MdOutlinePeople className="size-5 mr-2" />
                List Employees
              </Link>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
...
export const jobListColumnsViewer: ColumnDef<ListAllJobsDto>[] = [
  //for Admin Job Manage Page
  {
    accessorKey: "job_id",
    header: "Job ID",
      ...
      return (
        <div className="flex flex-row">
          {job.status.status === "Closed" ? (
            <div className="flex flex-row bg-gray-300 p-2 rounded-md text-white justify-center cursor-not-allowed">
            ...
            <Link
              to={`/company/dashboard/list-interview-round/${job.job_id}`}
              className="flex flex-row bg-gray-500 p-2 rounded-md text-white justify-center hover:bg-gray-800 transition duration-200"
            >
              <AiOutlineSchedule className="size-5 mr-2" />
              Show Schedule
            </Link>
          )}
          <Link to={`/company/dashboard/jobs/view/${job.job_id}`}>
