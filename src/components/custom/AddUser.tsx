...
// Interface for the last user ID received from the API
export interface LastId{
    user_id: string | null;
}

// AddUser component for creating new users
const AddUser = () => {
  ...
  const [userData, setUserData] = useState<UserCreateDto>({
    ...
    email: "",
    user_id: "",
    password: "N/A", // Default password, likely to be changed or generated by backend
  });

  // State to store all available roles
  const [allRoles, setAllRoles] = useState<RoleDto[]>([]);
  // State to store roles selected for the new user
  ...
  // useEffect hook to fetch initial data (roles and last user ID) on component mount
  useEffect(() => {
  ...
  return (
    <Card className="bg-white text-gray-800 font-sans border-none shadow-none">
